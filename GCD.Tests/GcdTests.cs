namespace GCD.Tests
{
    ...
    public class GcdTests
    {
        ...
        public int Euclid_MultipleNonZeroNumbersInput_ValidResult(int a, int b, int c, params int[] numbers) =>
            Gcd.Euclid(a, b, c, numbers);
        ...
        public int Euclid_InputWithZeros_ValidResult(int a, int b, int c, params int[] numbers) =>
            Gcd.Euclid(a, b, c, numbers);
        ...
        public void Euclid_MultipleZeros_ThrowsArgumentException(int a, int b, int c, params int[] numbers) =>
            Assert.Throws<ArgumentException>(() => Gcd.Euclid(a, b, c, numbers));

        [Test]
        public void Euclid_NumbersNull_ThrowsArgumentNullException() =>
            Assert.Throws<ArgumentNullException>(() => Gcd.Euclid(10, 20, 30, null));
        ...
        [TestCase(423748, 42398, 326714, 21170, ExpectedResult = 58)]
        [TestCase(423748, 42398, 326714, 21170, 40368, ExpectedResult = 58)]
        public int Binary_MultipleNonZeroNumbersInput_ValidResult(int a, int b, int c, params int[] numbers) =>
            Gcd.Binary(a, b, c, numbers);

        [TestCase(0, 45, -75, ExpectedResult = 15)]
        [TestCase(8, 16, 0, 0, ExpectedResult = 8)]
        [TestCase(0, 0, 5, 10, ExpectedResult = 5)]
        [TestCase(0, 0, 5, ExpectedResult = 5)]
        public int Binary_InputWithZeros_ValidResult(int a, int b, int c, params int[] numbers) =>
            Gcd.Binary(a, b, c, numbers);
        ...
        [TestCase(0, 0, 0)]
        [TestCase(0, 0, 0, 0, 0, 0)]
        public void Binary_MultipleZeros_ThrowsArgumentException(int a, int b, int c, params int[] numbers) =>
            Assert.Throws<ArgumentException>(() => Gcd.Binary(a, b, c, numbers));

        [Test]
        public void Binary_NumbersNull_ThrowsArgumentNullException() =>
            Assert.Throws<ArgumentNullException>(() => Gcd.Binary(10, 20, 30, null));
    }
}
